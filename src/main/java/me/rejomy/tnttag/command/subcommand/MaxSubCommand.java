...
public class MaxSubCommand extends SubCommand {

    public MaxSubCommand() {
        super("max", "Set max players for a arena.");
    }
    ...
    public boolean onCommand(CommandSender sender, org.bukkit.command.Command command, String label, String[] args) {
        ...
        config.set("max", args[2]);

        file.getFileUtil().save(file.getFile(), config);

        sendMessage(sender, "Max value " + args[2] + " has been set!");
